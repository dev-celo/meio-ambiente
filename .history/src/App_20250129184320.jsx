...
const DynamicSelect = () => {
  ...
  const processarEmpreendimento = () => {
    ...
    const unidadeMedida = data[selectedDivision][selectedGroup][selectedSubGroup]?.unidade_medida;
    const porte = data[selectedDivision][selectedGroup][selectedSubGroup]?.porte;
    const potencialPoluidor = data[selectedDivision][selectedGroup][selectedSubGroup]?.potencial_poluidor;
